...
<header>
        ...
        <?php
            ...
            {
                echo "<br><br><br><br><br>";
                echo "<center><h2>No active deliveries</h2></center>";
                echo "<br><br><br><br><br>";
            }
            ...
            echo "<br><br><center><h2>Active Orders</h2></center>";
            while ($arr=mysqli_fetch_array($orders,MYSQLI_NUM))
            {
                ...
                echo "<table border = '1' >";
                    ...
                    echo "<tr>";
                        echo "<td><button onclick=\"document.location='dp_confirm.php?status=delivered&oid=$arr[0]'\">Mark Delivered</button</td>";
                    echo "</tr>";
