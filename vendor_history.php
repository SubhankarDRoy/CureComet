...
<header>
    ...
    <?php
        ...
        $query="Select Count(*) from orders where vendor_id like '$user'";
        $booking_count=mysqli_query($con,$query);
        $arr=mysqli_fetch_array($booking_count,MYSQLI_NUM);
        if($arr[0]==0)
        {
            echo "<br><br><br><br><br>";
            echo "<center><h2>No orders requested</h2></center>";
            echo "<br><br><br><br><br>";
        }


        $query="Select * from orders where vendor_id like '$user';";
        ...
        while ($arr=mysqli_fetch_array($vendor_list,MYSQLI_NUM))
        {
            ...
            echo "<table border = '1' >";
                ...
                echo "</td></tr>";
                    ...
                    echo "<tr>";
                        echo "<td>Order Date:</td><td>$arr[12]</td>";
                    echo "</tr>";
            echo "</table>";
