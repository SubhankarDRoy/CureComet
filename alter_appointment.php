...
<header>
    ...
    <?php
        ...
        switch($status)
        {
            case "confirm": $sql="UPDATE appointments SET `status`='Appointment confirmed' where appointment_id=$aid";
                            break;

            case "reject": $sql="UPDATE appointments SET `status`='Appointment confirmed' where appointment_id=$aid";
                            break;
