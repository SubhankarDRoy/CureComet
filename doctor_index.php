...
<header>
        ...
        <?php
            ...
            if(!$vendor_list)
            {
                echo "<center><h2>No active appointment requests</h2></center>";
            }
            ...
            while ($arr=mysqli_fetch_array($vendor_list,MYSQLI_NUM))
            {
                ...
                echo "<table border = '1' >";
                    ...
                    echo "<tr>";
                        ...
                        echo "<td><button class=\"clear-button\" onclick=\"document.location='alter_appointment.php?status=reject&aid=$arr[0]'\">Reject</button</td>";
                        echo "<td><button class=\"clear-button\" onclick=\"document.location='alter_appointment.php?status=reason_reject&aid=$arr[0]'\">Reject with reason</button</td>";
                    echo "</tr>";
                echo "</table>";
